#!/usr/bin/env python3
"""
Generate SVG of cadmium emission spectra in the same format as SodiumEmissionSpectra_f.svg.
Uses data from cadmium_air_lines.csv and maps intensity to opacity.
"""
...
def read_cadmium_data(csv_file):
    """Read cadmium emission line data from CSV."""
    lines = []
...
def generate_svg(csv_file, output_file):
    ...
    lines = read_cadmium_data(csv_file)
...
if __name__ == '__main__':
    csv_file = 'cadmium_air_lines.csv'
    output_file = '../image/spin-representation/CadmiumEmissionSpectra_f.svg'
